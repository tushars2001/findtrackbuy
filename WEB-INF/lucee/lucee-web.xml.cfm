<?xml version="1.0" encoding="UTF-8"?><cfLuceeConfiguration hspw="609f504dc48358a2b075b3c34b134174ff306b2b32ffb3ea9bc0d2a4172f931a" salt="935D98FF-811C-4D42-9B3655E11FF6BFF9" version="4.5"><cfabort/>
...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
	<data-source allow="511" blob="false" class="org.gjt.mm.mysql.Driver" clob="false" connectionLimit="-1" connectionTimeout="1" custom="useUnicode=true&amp;characterEncoding=UTF-8&amp;useLegacyDatetimeCode=true" database="quirkycr_dev" dbdriver="MySQL" dsn="jdbc:mysql://{host}:{port}/{database}" host="localhost" metaCacheTimeout="60000" name="product" param-delimiter="&amp;" param-leading-delimiter="?" param-separator="=" password="encrypted:e48b0d1c52e689f6693af88ff50d01f54a86dd4d3aee04ab93283815735fbac57cc64bd0a8c2bbc3" port="3306" storage="true" username="quirkycr_dev" validate="false"/></data-sources>
	...
	-->
	<scope applicationtimeout="1,0,0,0" cascade-to-resultset="true" cascading="standard" cgi-readonly="true" client-directory="{lucee-web}/client-scope/" client-directory-max-size="100mb" clientmanagement="true" clientstorage="cookie" clienttimeout="90,0,0,0" local-mode="classic" merge-url-form="false" session-type="cfml" sessionmanagement="true" sessionstorage="memory" sessiontimeout="0,0,30,0" setclientcookies="true" setdomaincookies="false"/>
		
	<mail>
	<server password="encrypted:a5bf582931047ad1a63c432effbfa9f705759b0c34f36d8eb391648b8559cbbc" port="25" smtp="mail.quirkycrackers.com" ssl="false" tls="false" username="friends@quirkycrackers.com"/></mail>
	...
	<application allow-url-requesttimeout="true" cache-directory="{lucee-web}/cache/" cache-directory-max-size="100mb" requesttimeout="0,0,0,50" script-protect="all"/>
